...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @param \Interrapidisimo\Credibanco\Model\ConfigFactory $configFactory,
    ...
    public function __construct(
        ...
        \Interrapidisimo\Credibanco\Model\ConfigFactory $configFactory,
     ...
     * @return \Interrapidisimo\Credibanco\Model\ConfigFactory
     */
    ...
    public function lookUpPaymentTransaction($payment, array $transactionTypes)
    {
        ...
        while (isset($transaction)) {
            if (in_array($transaction->getTxnType(), $transactionTypes)) {
                if($transaction->getTxnType() == \Magento\Sales\Model\Order\Payment\Transaction::TYPE_ORDER){
