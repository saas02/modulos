...
class Config implements \Magento\Payment\Model\Method\ConfigInterface
{
    ...
    public function initGatewayClient()
    {
        ...
        \BeGateway\Settings::$registerBase = $this->getDomainGateway();
        \BeGateway\Settings::$loginBase = $this->getDomainCheckout();
        \BeGateway\Settings::$domainReturn = $this->getDomainReturn();        
    }
     ...
     * @return null|string
     */
    public function getDomainReturn()
    {
        return $this->getValue('domain_return');
    }
